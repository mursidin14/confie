            ...
            <article className="mb-5 items-center gap-5 rounded-md bg-[#FFF6E7] py-7 px-3 shadow-mine sm:flex sm:px-8">
              ...
              <div className="text-left">
                ...
                <p className="text-xs lg:text-sm">
                  Silahkan klik tombol atau link verifikasi pada email yang
                  dikirimkan oleh confie.id ke email anda. Apabila anda tidak
                  menerima email apapun, silahkan periksa atau ganti email anda
                  pada{' '}
                  <a
                    href="/setting"
                    className="font-semibold italic text-[#7588CD]"
                  >
                    Account Setting
                  </a>{' '}
