    ...
    <Layout userId={id} PageName={'Lamaran Saya'}>
      <div className="rounded-md bg-white p-6 shadow-mine">
        <div className="lg:flex w-full items-center justify-between">
          ...
          <div className="flex items-center lg:justify-end gap-4 lg:mt-0 mt-3 flex-wrap lg:text-sm text-xs">
            <SelectBox menus={filter_time}></SelectBox>
            <SelectBox menus={filter_status}></SelectBox>
            <button className="lg:text-sm text-xs primary-btn flex w-fit items-center justify-center gap-2 rounded-md px-5 py-3">
              <svg
                width="15"
                height="15"
                viewBox="0 0 15 15"
...
function Table({ items }) {
  return (
    <table className="mt-5 w-full min-w-[700px] table-fixed text-center text-xs sm:text-base">
      <thead className=" ">
        <tr className="h-[60px] text-sm text-[#B5B5C3] border-b border-b-solid ">
