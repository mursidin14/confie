  ...
  return (
      ...
      <main className="flex lg:p-5 md:w-fit md:mx-auto shadow-mine">
        <section className="bg-dark-blue py-10 sm:px-7 px-3 text-white ">
          <div className="">
            <img className="rounded-full lg:w-32 sm:w-24 w-16 mx-auto" src="/person.png" alt="" />
            <div className="mt-5 flex items-center justify-center sm:gap-3 gap-1">
              <p className="sm:text-lg text-sm">Rahmat Hidayat</p>
              <svg
                className="h-5 w-5"
                width="28"
                height="28"
            ...
            <p className="mt-1 text-center sm:text-sm text-xs">Teknik Informatika</p>
          </div>
          <EmploymentStatus />
          <BasicInformation />
          <SkillInfomation />
        ...
        <section className="lg:w-[500px] w-fit text-[#7E8299]">
          <AboutMe></AboutMe>
...
function EmploymentStatus({}) {
  return (
    <p className="my-3 mx-auto w-fit rounded-sm bg-[#E8FFF3] sm:px-5 px-2 py-1 text-[10px] text-[#50CD89] sm:text-sm text-xs">
      Bekerja
    </p>
  );
}
...
function BasicInformation({}) {
  return (
    <section className="mt-10 sm:text-sm text-xs space-y-5">
...
function SkillInfomation({}) {
  return (
    <section className="mt-20">
      <p className="sm:mb-6 mb-2  text-left sm:text-xl text-sm font-semibold">Skills</p>
      <div className="text-left sm:text-sm text-xs sm:space-y-3 space-y-1">
        <p>Akuntansi</p>
        <p>Coding</p>
        <p>Marketing</p>
      </div>
...
function CertificationInformation({}) {
  return (
    <section className="sm:mt-20 mt-10">
      <p className="sm:mb-6 mb-2 text-left sm:text-xl text-sm font-semibold">
        Award & Certification
      </p>
      <div className="pr-10 text-left sm:text-sm text-xs sm:space-y-3 space-y-1 sm:w-[240px]">
        <div>
          <p>Most Outstanding Employee of the Year (2015)</p>
          <div className="flex items-center gap-4">
            <hr className="w-2 border-b-[0.5px] border-white" />
            <p className="text-xs mt-1">Pixelpoint Hive</p>
          </div>
        </div>
        <div>
          <p>Most Outstanding Employee of the Year (2015)</p>
...
function AboutMe({}) {
  return (
    <article className="mt-10">
      ...
      <p className="my-6 sm:pl-8 px-3 text-left md:text-sm text-xs md:w-[500px] w-fit">
...
function WorkExperience({}) {
  return (
    ...
    <InformationTitle title={"Work Experience"}/>
      <div className='sm:pl-8 px-3'>
        <div className="my-8 text-left md:text-sm text-xs w-fit">
          <p className="sm:text-xl text-base text-[#3F4254]">Junior React Developer</p>
...
function EducationHistory({}) {
  return (
    ...
    function InformationTitle({title}) {
      return (<div className="bg-[#7E8299] py-4">
        <p className="pl-8 text-left md:text-xl text-sm font-semibold text-white">
         {title}
        </p>
      </div>);
    }
