  ...
  return (
    <div className="App">
      <Routes>
		...
		<Route path='/guide/map' element={ <PrivateRoute children={<CarrerMap />} role='personal' /> } />
		<Route path='/guide/exploration' element={ <PrivateRoute children={<ExplorationCarrer />} role='personal' /> } />
		<Route path='/lowongan' element={ <PrivateRoute children={<Jobs />} role='personal' /> }/>
		<Route path='/lowongan/detail-job/:idDetail' element={ <PrivateRoute children={<JobDetail />} role='personal' /> } />
		<Route path='/lamaran/' element={ <PrivateRoute children={<Application />} role='personal' /> } />
		<Route path='/lamaran/detail/:id' element={ <PrivateRoute children={<ApplicationDetail />} role='personal' /> } />
		<Route path='/kelas' element={ <PrivateRoute children={<Class />} role='personal' /> } />
		<Route path='/kelas/detailKelas/detail' element={ <PrivateRoute children={<ClassDetail />} role='personal' /> } />
		<Route path='/faq' element={ <PrivateRoute children={<FAQ />} role='personal' /> } />
		<Route path='/billing' element={ <PrivateRoute children={<Billing />} role='personal' /> } />
		...
		{/* Route for business */}
		<Route path='/business' element={ <PrivateRoute children={<Business />} role='business' /> } />
		<Route path='/business/profile' element={ <PrivateRoute children={<BusinessProfile />} role='business' /> } />
		<Route path='/business/team' element={ <PrivateRoute children={<TeamMember />} role='business' /> } />
		<Route path='/business/job' element={ <PrivateRoute children={<JobVacancy />} role='business' /> } />
		<Route path='/business/job/create' element={ <PrivateRoute children={<OpenJobVacancy />} role='business' /> } />
		<Route path='/business/job/detail/:idJob' element={ <PrivateRoute children={<JobVacancyDetail />} role='business' /> } />
