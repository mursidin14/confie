...
import { deleteGallery, updateGallery } from 'services/Profile/ProfileService';
  ...
  return (
    <>
      <div className="image-upload">
        ...
        <input id="input-gallery" type="file" onChange={(e)=>{
          uploadPhoto(e);
          setIsOpen(true);
        }} />
      </div>
                      ...
                      <>
                        ...
                        <p className="mx-auto mb-5 w-full text-center text-[#7E8299] lg:w-[400px]">
                          {isDelete
                            ...
                            : 'Apakah Anda ingin menambah gallery company?'}
                        </p>
                      </>
                    )}
