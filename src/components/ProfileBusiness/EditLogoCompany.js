...
export default function EditLogoCompany() {
  const {
    businessProfile: { url_photo_profile },
        ...
        <div className="image-upload w-7/12">
          <label htmlFor="file-input">
            <div className="relative mt-2 w-fit">
              ...
              <img
                className="w-20 sm:w-32 rounded-md"
                src={
                  url_photo_profile
              ...
              <button
              onClick={deletePhoto}
              className="absolute -bottom-3 -right-5 w-fit cursor-pointer rounded-full border bg-white p-2 shadow-md"
            >
              <svg
                width="11"
                height="11"
          ...
          <p className="mt-2 text-xs text-[#A1A5B7] sm:text-sm">
                    ...
                    <>
                      {isLoading ? (
                        ...
                        <div className="flex items-center justify-center p-8 gap-5">
                          <span className='bg-[#7E8299] p-3 rounded-full animate-bounceOne'></span>
                          <span className='bg-[#7E8299] p-3 rounded-full animate-bounceTwo'></span>
                          <span className='bg-[#7E8299] p-3 rounded-full animate-bounceOne'></span>
                        </div>
                        </>
                      ) : (
