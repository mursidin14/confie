...
export default function SalaryFilter() {
  ...
  return (
    <div className='w-full relative'>
      <button onClick={handleClick}  className="flex w-full h-[100%] items-center justify-between rounded-md bg-[#F5F8FA] px-5 text-center text-[#9CA3AF] transition-all placeholder:italic hover:bg-[#edf0f3]">
      ...
      <div className={`bg-white w-[300px] absolute -bottom-[160px] border-[0.5px] border-[#b1b1b1] py-4 px-6 rounded-md ${open ? 'translate-y-0  opacity-0' : ' translate-y-1 opacity-100'} transition-all`}>
